        ...
        <div class="p-3 my-3 border border-info rounded">
            ...
            <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="InputTitle" aria-describedby="emailHelp" placeholder="Enter the painting name:">
                        <br>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="InputYearPainted" placeholder="Enter the year the painting was painted:">
                        <br>
                    </div>
                    <div class="form-group">
                        <label for="InputMedia">Media Type</label>
                        <input type="text" class="form-control" id="InputMedia" placeholder="Enter the media type of the painting:">
                        <br>
                    </div>
                    <div class="form-group">
                        <label for="InputArtist">Artist Name</label>
                        <input type="text" class="form-control" id="InputArtist" placeholder="Enter the artist name of the painting:">
                        <br>
                    </div>
                    <div class="form-group">
                        <label for="InputStyle">Painting Style</label>
                        <input type="text" class="form-control" id="InputStyle" placeholder="Enter the style of the painting:">
                        <br>
                    </div>
                    <div>
